...
export default function Service() {
    ...
    return (
        <div>
            <section>
                <div className="px-4 py-24 mx-auto md:px-12 lg:px-4 max-w-screen-xl flex flex-col l justify-center">
                    <div className="flex flex-col justify-start w-full">
                        ...
                        <div className="mt-6 border-t pt-12">
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-24 items-baseline justify-start">
                                <div>
                            ...
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-24 items-baseline md:flex-row-reverse ">
                                <div>
                                    <span className="text-gray-600 uppercase text-xs font-medium">
                                        Just because we can
                                    </span>
                                    ...
                                    <div className="mt-6 text-xs font-medium grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-2 text-gray-950">
                                        <div className="inline-flex items-center gap-2 text-xs text-gray-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-database text-gray-700 size-4" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        ...
                                        <div className="inline-flex items-center gap-2 text-xs text-gray-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-building text-gray-700 size-4" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            ...
                                            <span className="text-gray-950 font-medium text-sm">Lowered Interference</span>
                                        </div>
                                        <div className="inline-flex items-center gap-2 text-xs text-gray-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-augmented-reality-2 text-gray-700 size-4" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            ...
                                            <span className="text-gray-950 font-medium text-sm">Improved Reliability</span>
                                        </div>
                                        <div className="inline-flex items-center gap-2 text-xs text-gray-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-time-duration-0 text-gray-700 size-4" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            ...
                                            <span className="text-gray-950 font-medium text-sm">Faster Processing Times</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="h-full">
                                    <img src="https://i.pinimg.com/564x/4e/a7/ff/4ea7ff230ad9f3bc1c30b1b6cbaccad3.jpg" alt="#_" className="bg-gray-200 shadow-box shadow-gray-500/30 overflow-hidden aspect-square w-full h-full object-cover object-center" />
                                </div>
                            </div>
                        </div>
                        {
                            ...
                            <div className={`${showPopUp? 'hidePopUp' : ''} pointer-events-none fixed z-50 inset-x-0 bottom-0 sm:flex sm:justify-center p-2`}>
                                    ...
                                    <div className="flex w-0 flex-1 items-center p-4">
                                        <div className="w-full">
                                            <div className="flex gap-2">
                                                ...
                                                <p className="text-sm font-medium text-neutral-900">Google Auth</p>
                                            </div>
                                    ...
                                    <div className="flex">
                                        <div className="flex flex-col divide-y divide-neutral-200">
                                            <div className="flex h-0 flex-1">
                                                <a onClick={() => setHidePopUp(true)} type="button" className="cursor-pointer flex w-full items-center justify-center rounded-none rounded-tr-lg border border-transparent px-4 py-3 text-sm font-medium text-pink-600 hover:text-pink-500 focus:z-10 focus:outline-none focus:ring-2 focus:ring-pink-500">Not Now</a>
                                            </div>
                                            <div className="flex h-0 flex-1">
                                                <a onClick={signInWithGoogle} className="cursor-pointer flex w-full items-center justify-center rounded-none rounded-br-lg border border-transparent px-4 py-3 text-sm font-medium text-neutral-700 hover:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-pink-500">Continue with Google</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
