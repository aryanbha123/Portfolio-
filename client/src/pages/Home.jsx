...
export default function Home() {
  ...
  <div className="bg-white shadow-lg rounded-lg px-8 py-6 mb-8">
    ...
    <div className="flex">
      ...
      <a href="https://api.whatsapp.com/send?phone=70172444279&text=Hi,%20I%20want%20to%20register%20for%20the%20Menstruation%20Education%20Webinar." target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Register via WhatsApp</a>
    </div>
